			...
			for (int i = 0; i < listCreatedFiles.size(); i++) {
				...
				if (data.numInstances() > 10) {
					...
					try {
						...
						svm.setOptions(weka.core.Utils.splitOptions("-S 1 -K 2 -D 5 -G 0.0 -R 0.0 -N 0.5 -M 40 -C 2.0 -E 0.001 -P 0.1 -Z -seed 1"));
					...
					evalMultiP.crossValidateModel(multiPerceptron, data, 10, new Random(10));
					
					writer.write("Multilayer Perceptron" + System.getProperty("line.separator"));
					writer.write(evalMultiP.toClassDetailsString() + System.getProperty("line.separator"));
					...
					evalVotedP.crossValidateModel(votedPerceptron, data, 10, new Random(10));
					
					writer.write("Voted Perceptron" + System.getProperty("line.separator"));
					writer.write(evalVotedP.toClassDetailsString() + System.getProperty("line.separator"));
					
					BayesNet bayes = new BayesNet();
					bayes.setOptions(weka.core.Utils.splitOptions("-D -Q weka.classifiers.bayes.net.search.local.SimulatedAnnealing -- -A 10.0 -U 10000 -D 0.999 -R 1 -S BAYES -E weka.classifiers.bayes.net.estimate.SimpleEstimator -- -A 0.5"));
