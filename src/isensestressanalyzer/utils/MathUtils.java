...
public class MathUtils {
    ...
    public static ArrayList<ArrayList<Double>> 
        normalizeSetOfLongData(ArrayList<ArrayList<Long>> values, 
         ...
         */
        ArrayList<ArrayList<Double>> norm = new ArrayList<>();
     ...
     */
    public static ArrayList<ArrayList<Double>> 
        normalizeSetOfDoubleData(ArrayList<ArrayList<Double>> values, 
            Double newMinValue, Double newMaxValue) {
        ...
        for (ArrayList<Double> subValues: values) {
            ...
            if (subValues != null && !subValues.isEmpty()) {
                ...
                for (int i = 0; i < subValues.size(); i++) {
                    ...
                    if (value != null) {
                        double newValue = ((double) (value - minValue) / 
    ...
    public static ArrayList<String> convertFeaturesToASetOfString(
        ...
        ArrayList<String> stringFeatures = new ArrayList<>();
